(function () {
    ...
    const morningIconSection = document.querySelector('.morningIcon');
    const afternoonIconSection = document.querySelector('.afternoonIcon');
    ...
    window.getWeather = (lat, lon, date) => {
        fetch(
            ...
            if (morningForecast) {
                ...
                const icon = morningForecast.weather[0].icon;
            ...
            if (afternoonForecast) {
                ...
                const icon = afternoonForecast.weather[0].icon;
