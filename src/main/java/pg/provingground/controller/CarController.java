...
public class CarController {
    ...
    public String carTypeList(@ModelAttribute CarTypeSearchForm searchForm, Model model) {
    ...
    public String searchCarType(@ModelAttribute CarTypeSearchForm searchForm, RedirectAttributes redirectAttributes) {
        System.out.println("form result: " + searchForm.type + " | " + searchForm.engine + " | " + searchForm.name);
    ...
    //차종 조건을 통해 검색
    public String carTypeListByCondition(Model model, @ModelAttribute("searchForm") CarTypeSearchForm searchForm) {
        List<CarType> types = carTypeService.findCarTypesByCondition(searchForm);
